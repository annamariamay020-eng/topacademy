...
export default class HeadComponent extends Component {
	...
	render() {
		...
		return <>
			<Head>
				<script src="https://t.contentsquare.net/uxa/065f98e2bed0a.js"></script>
			...
			<Script id="tawktoscriptwrapper" dangerouslySetInnerHTML={{
				__html: `var Tawk_API=Tawk_API||{ }, Tawk_LoadStart=new Date();
					...
					s1.async=true;
					s1.src='https://embed.tawk.to/694db715a872d4197df6f83b/1jdbp6bnn';
					s1.charset='UTF-8';
